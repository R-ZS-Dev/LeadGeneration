                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group mb-2">
                                    @foreach($viewCLGroups as $group)
                                    @php $checkboxId = 'group_' . $group->clg_id; @endphp
                                    <div class="form-check mb-1">
                                        <input class="form-check-input" type="checkbox" name="rowboxes[]" id="{{ $checkboxId }}" value="{{ $group->clg_name }}">
                                        <label class="form-check-label" for="{{ $checkboxId }}">{{ $group->clg_name }}</label>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <tbody>
                            ...
                            <tr id="row-{{ $viewClist->c_id }}">
                                ...
                                <td id="truncated-text"
                                    ...
                                    {{ implode(', ', json_decode($viewClist->rowboxes, true)) }}
                                </td>
                                <td>
...
<script>
    function editCLitem(clItem) {
        ...
        // ✅ Selected Rowboxes (Checked Checkboxes)
