                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="l_name" id="l_name" value="{{ old('l_name') }}" class="form-control" placeholder="Check list name" required>
                                    @error('l_name')
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="l_description" id="l_description" class="form-control" rows="4" placeholder="Enter Description..." required>{{ old('l_description') }}</textarea>
                                    @error('l_description')
                                    <small class="text-danger d-block text-start">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            @php
                            $checkboxes = [
                            "Anticoagulation", "Assisted Venous Return", "Backup", "Cardioplegia",
                            "Components (Lines/Pump Tubing)", "Electrical", "Emergency Restart Bypass",
                            "Gas Supply", "Monitoring", "Patient", "Post Bypass Checklist", "Pump",
                            "Safety Mechanisms", "Standard 18: Maintenance", "Sterility/Cleanliness",
                            "Supplies", "Temperature Control", "Termination Checklist"
                            ];
                            @endphp
                    ...
                    <table id="users-table" class="table table-striped table-bordered no-wrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td id="truncated-text" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 200px; cursor: pointer;" onclick="expandText(this)">{{ implode(', ', json_decode($viewClist->rowboxes, true)) }}</td>
                                <td>
        ...
        <div class="modal-content ">
            <div class="modal-body ">
                ...
                <form method="POST" action="{{ route('update-clist') }}" class="mt-4">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <input type="hidden" name="c_id" id="c_id" value="{{ $checklist->c_id ?? '' }}">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                <label for="l_description">Description</label>
                                <textarea name="l_description" id="editl_description" class="form-control" rows="4" placeholder="Enter Description...">{{ old('l_description') }}</textarea>
                                @error('l_description')
                                <small class="text-danger d-block text-start">{{ $message }}</small>
                                @enderror
                            </div>
