<nav class="sidebar-nav">
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item mt-3"> <a class="sidebar-link" href="{{ route('all-users') }}"
        ...
        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span
                    ...
                    <ul aria-expanded="false" class="collapse  first-level base-level-line">
                        ...
                        <li class="sidebar-item"><a href="{{ route('report-review') }}" class="sidebar-link"><span class="hide-menu"> Report Review </span></a></li>
                        ...
                        <li class="sidebar-item"><a href="{{ route('live-line') }}" class="sidebar-link"><span class="hide-menu"> Live Line</span></a></li>
                    </ul>
        </li>
