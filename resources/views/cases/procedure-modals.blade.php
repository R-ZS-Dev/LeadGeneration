                ...
                <div class="card-body">
                    <form method="POST" action="#" class="mt-4">
                                                ...
                                                <div class="col-lg-12 mt-3 mb-3">
                                                    <div class="title-box">
                                                        ...
                                                        <div class="row form-group mt-3 mb-3">
                                                            ...
                                                            <div class="col-md-6 d-flex">
                                                                <label>
                                                                    <input type="radio" name="secexplant_devic"
                                                                        value="Yes" id="secexplant_devic_yes"
                                                                        />
                                                                    <span>Yes</span>
                                                                </label>
                                                                <label class="ms-2">
                                                                    <input type="radio" name="secexplant_devic"
                                                                        value="No" id="secexplant_devic_no" checked>
                                                                    <span>No</span></label>
                                                            </div>

                                                        </div>
                                                        <div class="row form-group mb-3" id="secexplant-devic-yes" style="display: none;">
                                                            <div class="col-lg-12 ">
                                                                <div class="title-box">
                                                                    <span class="title-label">If Yes</span>
                                                                    <div class="row form-group mb-3">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-8 d-flex">
                                <label>
                                    <input type="radio" name="aortic_valve_pro" value="Yes" id="aorticvalve_yes"
                                        checked />
                                    <span>Yes</span></label>

                                <label class="ms-2">
                                    <input type="radio" name="aortic_valve_pro"
                                                            ...
                                                            <div class="row form-group  mb-3">
                                                                ...
                                                                <div class="col-md-6 d-flex">
                                                                    <label for="transcat_yes">
                                                                        <input type="radio" name="transcat"
                                                                            value="Yes" id="transcat_yes" />
                                                                        <span>Yes</span></label>
                                                                    <label class="ms-2">
                                                                        <input type="radio" name="transcat"
                                                                            value="No" id="transcat_no" checked>
                                                                        <Span>No</Span></label>

                                                                </div>
                                                            </div>
                                                            <div class="row form-group mb-3" id="transcat-yes" style="display:none;">
                                                                <div class="col-md-12">
                                                                    <div class="title-box">
                                                                        <span class="title-label">If Yes</span>
                                                                    ...
                                                                    <div class="col-md-6 d-flex">
                                                                        <label>
                                                                            <input type="radio" name="leafletpericard"
                                                                                value="Yes" id="leafletpericard_yes"
                                                                                checked />
                                                                            <span>Yes</span>
                                                                        </label>
                                                                        <label class="ms-2">
                                                                    ...
                                                                    <div class="col-md-6 d-flex">
                                                                        <label>
                                                                            <input type="radio" name="leafletdebridt"
                                                                                value="Yes" id="leafletdebridt_yes"
                                                                                checked>
                                                                            <span>Yes</span>
                                                                        </label>
                                                                        <label class="ms-2">
                                                        ...
                                                        <div class="row form-group mb-2 mt-3">
                                                            <div class="col-lg-12">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-8 d-flex">
                                                                        <label>
                                                                            <input type="radio" name="annular"
                                                                                value="Yes" id="annular_yes" >
                                                                            <span>Yes</span>
                                                                        </label>
                                                                        <label class="ms-2">
                                                                            <input type="radio" name="annular"
                                                                                value="No" id="annular_no" checked>
                                                                            <span>No</span>
                                                                        </label>
                                                                    </div>
                                                                </div>
                        ...
                        <div class="row form-group mt-3">
                            <div class="col-lg-12">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 d-flex">
                                        <label>
                                            <input type="radio" name="mitrlvalve" value="Yes"
                                                id="mitrlvalve_yes" checked>
                                            <span>Yes</span>
                                        </label>
                                        <label class="ms-2">
                                            <input type="radio" name="mitrlvalve"
                                                value="Yes, unplanned surgical complication"
                                                id="mitrlvalve_no">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 d-flex ">
                                        <label>
                                            <input type="radio" name="mitral_performed" value="No"
                                                id="performed_no" checked>
                                            <span>No</span>
                                        </label>
                                        <label class="ms-2">
                                            <input type="radio" name="mitral_performed"
                                                value="Yes, unplanned disease/anatomy" id="performed_yes">
                            ...
                            <div class="col-md-12">
                                <div class="title-box">
                                    ...
                                    <div class="col-lg-11 mx-auto">
                                        ...
                                        <select name="mitral_perform" id="mitral-procs"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <select name="resectloc"
                                                                            ...
                                                                            <option value="Posterior">
                                                                                Posterior</option>
                                                                            <option
                                                                                value="Both Anterior and Posterior">
                                                        ...
                                                        <div class="col-md-12" id="neochords-yes" style="display: none;">
                                                            <div class="title-box">
                                                                ...
                                                                <label for="">No of neochords
                                                                    inserted</label>
                                                                <input type="text" name="neochard"
                                                                    class="form-control" id=""
                                                                    placeholder="No of neochards inserted">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 mt-3">
                                                            <div class="row form-group mb-3">
                                                                ...
                                                                <div class="col-lg-6 d-flex">
                                                                    <label>
                                                                        <input type="radio"
                                                                            name="chordal_leaflet_transfer"
                                                                            value="Yes"
                                                                            id="chordal_leaflet_transfer_yes"
                                                                            checked />
                                                                        <span>Yes</span>
                                                                    </label>
                                                                    <label class="ms-2">
                                                            ...
                                                            <div class="row form-group mb-3">
                                                                ...
                                                                <div class="col-lg-6 d-flex">
                                                                    <label>
                                                                        <input type="radio"
                                                                            name="leaflet_extension"
                                                                            value="Yes"
                                                                            id="leaflet_extension_yes"
                                                                            checked />
                                                                        <span>Yes</span>
                                                                    </label>
                                                                    <label class="ms-2">
                                                            ...
                                                            <div class="row form-group mb-3">
                                                                ...
                                                                <div class="col-lg-6 d-flex">
                                                                    <label>
                                                                        <input type="radio"
                                                                            name="edge_to_edge_repair"
                                                                            value="Yes"
                                                                            id="edge_to_edge_repair_yes"
                                                                            checked />
                                                                        <span>Yes</span>
                                                                    </label>
                                                                    <label class="ms-2">
                                                            ...
                                                            <div class="row form-group mb-3">
                                                                ...
                                                                <div class="col-lg-6 d-flex">
                                                                    <label>
                                                                        <input type="radio"
                                                                            name="mitral_leaflet_clip"
                                                                            value="Yes"
                                                                            id="mitral_leaflet_clip_yes"
                                                                            checked />
                                                                        <span>Yes</span>
                                                                    </label>
                                                                    <label class="ms-2">
                                                            ...
                                                            <div class="row form-group mb-3">
                                                                ...
                                                                <div class="col-lg-6 d-flex">
                                                                    <label>
                                                                        <input type="radio"
                                                                            name="mitral_commissurotomy"
                                                                            value="Yes"
                                                                            id="mitral_commissurotomy_yes"
                                                                            checked />
                                                                        <span>Yes</span>
                                                                    </label>
                                                                    <label class="ms-2">
                                                            ...
                                                            <div class="row form-group mb-3">
                                                                ...
                                                                <div class="col-lg-6 d-flex">
                                                                    <label>
                                                                        <input type="radio"
                                                                            name="mitral_commissuroplasty"
                                                                            value="Yes"
                                                                            id="mitral_commissuroplasty_yes"
                                                                            checked />
                                                                        <span>Yes</span>
                                                                    </label>
                                                                    <label class="ms-2">
                                                            ...
                                                            <div class="row form-group mb-3">
                                                                ...
                                                                <div class="col-lg-6 d-flex">
                                                                    <label>
                                                                        <input type="radio"
                                                                            name="mitral_cleft_repair"
                                                                            value="Yes"
                                                                            id="mitral_cleft_repair_yes"
                                                                            checked />
                                                                        <span>Yes</span>
                                                                    </label>
                                                                    <label class="ms-2">
                                                ...
                                                <div class="title-box">
                                                    ...
                                                    <div class="row form-group mb-2">
                                                        ...
                                                        <div class="col-lg-4 d-flex">
                                                            <label>
                                                                <input type="radio" name="attempt_prior"
                                                                    value="Yes" id="attempt_prior_yes"
                                                                    checked />
                                                                <span>Yes</span>
                                                            </label>
                                                            <label class="ms-2">
                                                    ...
                                                    <div class="row form-group mb-3">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="mitral_chords" id=""
                                                                placeholder="Mitral Chords Preserved">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group mb-2">
                                                        <div class="col-md-8">
                                        ...
                                        <div class="row form-group mb-2">
                                            ...
                                            <div class="col-lg-4 d-flex">
                                                <label>
                                                    <input type="radio" name="mitral_implnt"
                                                        value="Yes" id="mitral_implnt_yes" />
                                                    <span>Yes</span>
                                                </label>
                                                <label class="ms-2">
                                                    <input type="radio" name="mitral_implnt"
                                                        value="No" id="mitral_implnt_no" checked />
                                                    <span>No</span>
                                                </label>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-2">
                                                            <label for="">Mitral Iplant Model
                                                                Number</label>
                                                            <input type="text" name="mitral_imn"
                                                                id="" class="form-control">
                                                        </div>
                                                        <div class="col-md-6 mb-2">
                                                            <label for="">Mitral Iplant
                                                                Size</label>
                                                            <input type="text" name="mitral_size"
                                                                id="" class="form-control">
                                                        </div>
                                                        <div class="col-md-6 mb-2">
                                                            <label for="">Unique device
                                                                identifer</label>
                                                            <input type="text" name="mitral_udi"
                                                                id="" class="form-control">
                                                        </div>
                                                        <div class="col-md-6 mb-2">
                                                            <label for="">Expiration</label>
                                                            <input type="text" name="mitral_exp"
                                                                id="" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="row form-group mb-2">
                            ...
                            <div class="col-lg-8 d-flex">
                                <label>
                                    <input type="radio" name="tricuspidper" value="No" id="tricuspidper_no"
                                        checked />
                                    <span>No</span>
                                </label>
                                <label class="ms-2">
                                        ...
                                        <div class="col-lg-12 mt-2 mb-2" id="tricuspid-repair" style="display: none;">
                                            <div class="title-box">
                                                ...
                                                <div class="row form-group mb-2">
                                                    ...
                                                    <div class="col-lg-4 d-flex">
                                                        <label>
                                                            <input type="radio" name="transtricusp_replace"
                                                                value="Yes" id="transtricusp_replace_yes" checked />
                                                            <span>Yes</span>
                                                        </label>
                                                        <label class="ms-2">
                                                            <input type="radio" name="transtricusp_replace"
                                                                value="No" id="transtricusp_replace_no" />
                                                            <span>No</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 form-group mb-3">
                                                        <label for="">Tricuspid Implant Model
                                                            Number#</label>
                                                        <input type="text" name="tricuspid_modelno"
                                                            class="form-control" id=""
                                                            placeholder="Tricuspid Implant model number">
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 form-group mb-3">
                                                        <label for="">Tricuspid Implant
                                                            Type</label>
                                                        <select name="tricuspid_implnt" id=""
                                                            class="form-select">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 form-group mb-3">
                                                        <label for="">Tricuspid Implant
                                                            Size</label>
                                                        <input type="text" name="tricuspidimp_size"
                                                            class="form-control" id=""
                                                            placeholder="Tricuspid Implant Size">
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 form-group mb-3">
                                                        <label for="">Unique Device
                                                            Identifier</label>
                                                        <input type="text" name="tricuspidimp_udi"
                                                            class="form-control" id=""
                                                            placeholder="Unique Device Identifier">
                                                    </div>
                        ...
                        <div class="row form-group mb-2">
                            ...
                            <div class="col-lg-8 d-flex">
                                <label>
                                    <input type="radio" name="pulmonic" value="Yes" id="pulmonic_yes"
                                        checked />
                                    <span>Yes</span>
                                </label>
                                <label class="ms-2">
                        ...
                        <div class="row form-group mb-2">
                            ...
                            <div class="col-lg-8 d-flex">
                                <label>
                                    <input type="radio" name="pulmonicper" value="No" id="pulmonicper_no"
                                        checked />
                                    <span>No</span>
                                </label>
                                <label class="ms-2">
                                        ...
                                        <div class="col-lg-12 mt-2 mb-2" id="pulmonic-replace" style="display: none;">
                                            <div class="title-box">
                                                ...
                                                <div class="row form-group mb-2">
                                                    ...
                                                    <div class="col-lg-4 d-flex">
                                                        <label>
                                                            <input type="radio" name="pulmonictrans_replace"
                                                                value="Yes" id="pulmonictrans_replace_yes" checked />
                                                            <span>Yes</span>
                                                        </label>
                                                        <label class="ms-2">
                                                            <input type="radio" name="pulmonictrans_replace"
                                                                value="No" id="pulmonictrans_replace_no" />
                                                            <span>No</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 form-group mb-3">
                                                        <label for="">Pulmonic Implant Model
                                                            Number#</label>
                                                        <input type="text" name="pulmonicimp_modelno"
                                                            class="form-control" id=""
                                                            placeholder="Pulmonic Implant model number">
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 form-group mb-3">
                                                        <label for="">Pulmonic Implant
                                                            Type</label>
                                                        <select name="pulmonic_implnt" id=""
                                                            class="form-select">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 form-group mb-3">
                                                        <label for="">Pulmonic Implant
                                                            Size</label>
                                                        <input type="text" name="pulmonicimp_size"
                                                            class="form-control" id=""
                                                            placeholder="Pulmonic Implant Size">
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 form-group mb-3">
                                                        <label for="">Unique Device
                                                            Identifier</label>
                                                        <input type="text" name="pulmonicimp_udi"
                                                            class="form-control" id=""
                                                            placeholder="Unique Device Identifier">
                                                    </div>
            ...
            <div class="card text-left">
              ...
              <div class="card-body">
                <div class="row form-group mt-3 mb-3">
                    ...
                    <div class="col-md-12">
                        <label>
                            <input type="radio" name="carotid" value="Yes Planned"/>
                            <span>Yes Planned</span>
                        </label>
                        <label class="ms-2">
                            <input type="radio" name="carotid" value="Yes, Unplanned Surgical Complication"/>
                            <span>Yes, Unplanned Surgical Complication</span>
                        </label>
                        <label class="ms-2">
                            <input type="radio" name="carotid" value="Yes, Unplanned Disease/Anatomy"/>
                            <span>Yes, Unplanned Disease/Anatomy</span>
                        </label>
                        <label class="ms-2">
                            <input type="radio" name="carotid" value="No" checked/>
                            <span>No</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="row form-group mt-3 mb-3">
                    ...
                    <div class="col-md-12 ">
                        <label>
                            <input type="radio" name="vascular" value="Yes Planned"/>
                            <span>Yes Planned</span>
                        </label>
                        <label class="ms-2">
                            <input type="radio" name="vascular" value="Yes, Unplanned Surgical Complication"/>
                            <span>Yes, Unplanned Surgical Complication</span>
                        </label>
                        <label class="ms-2">
                            <input type="radio" name="vascular" value="Yes, Unplanned Disease/Anatomy"/>
                            <span>Yes, Unplanned Disease/Anatomy</span>
                        </label>
                        <label class="ms-2">
                            <input type="radio" name="vascular" value="No" checked/>
                            <span>No</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="row form-group mt-3 mb-3">
                    ...
                    <div class="col-md-12">
                        <label>
                            <input type="radio" name="thoracic" value="Yes Planned"/>
                            <span>Yes Planned</span>
                        </label>
                        <label class="ms-2">
                            <input type="radio" name="thoracic" value="Yes, Unplanned Surgical Complication"/>
                            <span>Yes, Unplanned Surgical Complication</span>
                        </label>
                        <label class="ms-2">
                            <input type="radio" name="thoracic" value="Yes, Unplanned Disease/Anatomy"/>
                            <span>Yes, Unplanned Disease/Anatomy</span>
                        </label>
                        <label class="ms-2">
                            <input type="radio" name="thoracic" value="No" checked/>
                            <span>No</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="row form-group mt-3 mb-3">
                    ...
                    <div class="col-md-12">
                        <label>
                            <input type="radio" name="other" value="Yes Planned"/>
                            <span>Yes Planned</span>
                        </label>
                        <label class="ms-2">
                            <input type="radio" name="other" value="Yes, Unplanned Surgical Complication"/>
                            <span>Yes, Unplanned Surgical Complication</span>
                        </label>
                        <label class="ms-2">
                            <input type="radio" name="other" value="Yes, Unplanned Disease/Anatomy"/>
                            <span>Yes, Unplanned Disease/Anatomy</span>
                        </label>
                        <label class="ms-2">
                            <input type="radio" name="other" value="No" checked/>
                            <span>No</span>
                        </label>
                    </div>
                </div>
