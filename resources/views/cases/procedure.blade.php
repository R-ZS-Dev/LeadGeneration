                                ...
                                <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="approach_type" value="planned" id="planned"
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="approach_type" value="unplanned" id="unplanned"
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="approach_type" value="no" id="no"
                                                                    {{ old('approach_type') == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="robot_use" value="yes" id="robot_yes"
                                                                    {{ old('robot_use') == 'yes' ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                                    for="robot_yes">Yes</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="robot_use" value="no" id="robot_no"
                                                                    {{ old('robot_use') == 'no' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-lg-7">
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="robot_use" value="entire"
                                                                        id="robot_entire">
                                                                    <label class="form-check-label"
                                                                        for="robot_entire">Entire
                                                                        operation</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="robot_use" value="part" id="robot_part">
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="valve_surgery" value="yes" id="valve_yes"
                                                                    {{ old('valve_surgery') == 'yes' ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                                    for="valve_yes">Yes</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="valve_surgery" value="no" id="valve_no"
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="vad_implant" value="yes" id="implant_yes"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="vad_implant" value="no" id="implant_no"
                                                                    {{ old('vad_implant') == 'no' ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="other_cardiac" value="yes" id="cardiac_yes"
                                                                    {{ old('other_cardiac') == 'yes' ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                                    for="cardiac_yes">Yes</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="other_cardiac" value="no" id="cardiac_no"
                                                                    {{ old('other_cardiac') == 'no' ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                                    for="cardiac_no">No</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="cardiac_fib" value="yes" id="cardiacfib_yes"
                                                                    {{ old('cardiac_fib') == 'yes' ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                                    for="cardiacfib_yes">Yes</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="cardiac_fib" value="no" id="cardiacfib_no"
                                                                    {{ old('cardiac_fib') == 'no' ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                                    for="cardiacfib_no">No</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="non_cardic" value="yes" id="noncardic_yes"
                                                                    {{ old('non_cardic') == 'yes' ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                                    for="noncardic_yes">Yes</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="non_cardic" value="no" id="noncardic_no"
                                                                    {{ old('non_cardic') == 'no' ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                                    for="noncardic_no">No</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row  mb-3 mt-3">
                                            <div class="col-md-4 ">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" name="antibiotic"
                                                        value="Yes" id="antibiotic_yes">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row  mb-3 mt-3">
                                            <div class="col-md-4">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" name="antiadmin"
                                                        value="Yes" id="antiadmin_yes">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row mb-3 mt-3">
                                            <div class="col-md-4">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" name="antidiscon"
                                                        value="Yes" id="antidiscon_yes">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row mb-3 mt-3">
                                            <div class="col-md-4 ">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" name="addintra"
                                                        value="Yes" id="addintra_yes">
                                            ...
                                            <div class="title-box">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mt-2 mb-3">
                                                        <div class="form-check">
                                                            <input type="radio" class="form-check-input"
                                                                name="com_plan" value="Planned" id="com_planned">
                                                            <label class="form-check-label"
                                                                for="com_planned">Planned</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mt-2 mb-3">
                                                        <div class="form-check">
                                                            <input type="radio" class="form-check-input"
                                                                name="com_plan" value="Unplanned" id="com_unplan">
                                                            <label class="form-check-label"
                                                                for="com_unplan">Unplanned</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12 mt-2 mb-3">
                                                        <div class="title-box">
                                                            ...
                                                            <select name="unplan_reason" id=""
                                                                ...
                                                                <option
                                                                    value="Inadequate size and/or diffuse disease of distal vissel">
                                                                    Inadequate size and/or diffuse disease of distal vissel
                                                                </option>
                                                                <option
                                                                    value="Hemodynamic instability (hyptension/arrhythamias)">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mt-2 mb-3">
                                            <div class="title-box">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="cannulation" value="no" id="can_no">
                                                                    <label class="form-check-label"
                                                                        for="can_no">No</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="cannulation" value="yes" id="can_yes">
                                                                    <label class="form-check-label"
                                                                        for="can_yes">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="cannul_femo" value="no"
                                                                        id="canfemo_no">
                                                                    <label class="form-check-label"
                                                                        for="canfemo_no">No</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="cannul_femo" value="yes"
                                                                        id="canfemo_yes">
                                                                    <label class="form-check-label"
                                                                        for="canfemo_yes">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="cannul_axil" value="no"
                                                                        id="canaxil_no">
                                                                    <label class="form-check-label"
                                                                        for="canaxil_no">No</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="cannul_axil" value="yes"
                                                                        id="canaxil_yes">
                                                                    <label class="form-check-label"
                                                                        for="canaxil_yes">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="cannul_inno" value="no"
                                                                        id="caninno_no">
                                                                    <label class="form-check-label"
                                                                        for="caninno_no">No</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="cannul_inno" value="yes"
                                                                        id="caninno_yes">
                                                                    <label class="form-check-label"
                                                                        for="caninno_yes">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="cannul_other" value="no"
                                                                        id="canother_no">
                                                                    <label class="form-check-label"
                                                                        for="canother_no">No</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="cannul_other" value="yes"
                                                                        id="canother_yes">
                                                                    <label class="form-check-label"
                                                                        for="canother_yes">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="venous_femo" value="no"
                                                                        id="venousfemo_no">
                                                                    <label class="form-check-label"
                                                                        for="venousfemo_no">No</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="venous_femo" value="yes"
                                                                        id="venousfemo_yes">
                                                                    <label class="form-check-label"
                                                                        for="venousfemo_yes">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="venous_jugular" value="no"
                                                                        id="venousjugu_no">
                                                                    <label class="form-check-label"
                                                                        for="venousjugu_no">No</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="venous_jugular" value="yes"
                                                                        id="venousjugu_yes">
                                                                    <label class="form-check-label"
                                                                        for="venousjugu_yes">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="veno_right_artial" value="no"
                                                                        id="venoright_no">
                                                                    <label class="form-check-label"
                                                                        for="venoright_no">No</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="veno_right_artial" value="yes"
                                                                        id="venoright_yes">
                                                                    <label class="form-check-label"
                                                                        for="venoright_yes">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="veno_left_artial" value="no"
                                                                        id="venoleft_no">
                                                                    <label class="form-check-label"
                                                                        for="venoleft_no">No</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="veno_left_artial" value="yes"
                                                                        id="venoleft_yes">
                                                                    <label class="form-check-label"
                                                                        for="venoleft_yes">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="veno_pulmu" value="no" id="pulmo_no">
                                                                    <label class="form-check-label"
                                                                        for="pulmo_no">No</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="veno_pulmu" value="yes" id="pulmo_yes">
                                                                    <label class="form-check-label"
                                                                        for="pulmo_yes">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="veno_cav" value="no" id="venocav_no">
                                                                    <label class="form-check-label"
                                                                        for="venocav_no">No</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="veno_cav" value="yes" id="venocav_yes">
                                                                    <label class="form-check-label"
                                                                        for="venocav_yes">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="veno_other" value="no"
                                                                        id="venoother_no">
                                                                    <label class="form-check-label"
                                                                        for="venoother_no">No</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="veno_other" value="yes"
                                                                        id="venoother_yes">
                                                                    <label class="form-check-label"
                                                                        for="venoother_yes">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <input type="text" name="bypass_time" id=""
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="curcular_arrest" value="No"
                                                                    id="arrest_no">
                                                                <label class="form-check-label"
                                                                    for="arrest_no">No</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    name="curcular_arrest" value="Yes"
                                                                    id="arrest_yes">
                                                                <label class="form-check-label"
                                                                    for="arrest_yes">Yes</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="title-box">
                                                ...
                                                <div class="row form-group mb-3">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <input type="text" name="arrest_without_cerebral"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="arrest_with_cerebral" value="Yes"
                                                                        id="withyes">
                                                                    <label class="form-check-label"
                                                                        for="withyes">Yes</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="arrest_with_cerebral" value="No"
                                                                        id="withno">
                                                                    <label class="form-check-label"
                                                                        for="withno">No</label>
                                                                </div>
                                                    ...
                                                    <div class="title-box">
                                                        ...
                                                        <div class="col-lg-12 form-group mb-3">
                                                            <label for="">Circulatory Arrest without cerebral
                                                                perfusion
                                                                time (min)</label>
                                                            <input type="text" name="cerebral_perfus_time"
                                                        ...
                                                        <div class="col-lg-12 form-group mb-3">
                                                            ...
                                                            <div class="row mt-2">
                                                                <div class="col-md-4">
                                                                    <div class="form-check">
                                                                        <input type="radio" class="form-check-input"
                                                                            name="cerebral_perfus_type"
                                                                            value="Retrograde" id="perfutypere">
                                                                        <label class="form-check-label"
                                                                            for="perfutypere">Retrograte</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-check">
                                                                        <input type="radio" class="form-check-input"
                                                                            name="cerebral_perfus_type"
                                                                            value="Antegrade" id="perfutypean">
                                                                        <label class="form-check-label"
                                                                            for="perfutypean">Antegrade</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-check">
                                                                        <input type="radio" class="form-check-input"
                                                                            name="cerebral_perfus_type" value="Both"
                                                                            id="perfutypebo">
                                                                        <label class="form-check-label"
                                                                            for="perfutypebo">Both</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 form-group mb-3">
                                                            ...
                                                            <input type="text" name="circulat_arrest"
                                                                id="" class="form-control">
                                                        </div>
                                    ...
                                    <div class="row form-group mb-3">
                                        <div class="col-lg-12 mt-2 mb-3">
                                            <div class="title-box">
                                                ...
                                                <input type="text" name="cross_clamp" class="form-control"
                                                    id="">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="row  mb-3 mt-3">
                                            <div class="col-md-4 ">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" name="oximetry"
                                                        value="Yes" id="oximetry_yes">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="row  mb-3 mt-3">
                                            <div class="col-md-4 ">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" name="diffuse_aort"
                                                        value="Yes" id="diffuse_aort_yes">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="row  mb-3 mt-3">
                                            <div class="col-md-4 ">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" name="alterplan"
                                                        value="Yes" id="alterplan_yes">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="row  mb-3 mt-3">
                                            <div class="col-md-4 ">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" name="intraop"
                                                        value="Yes" id="intraop_yes">
