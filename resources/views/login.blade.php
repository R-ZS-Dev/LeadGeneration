                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        <label class="form-label text-dark" for="uemail">Email</label>
                                        <input class="form-control" id="uemail" type="text" name="email" value="{{ old('email') }}" placeholder="Enter your email">
